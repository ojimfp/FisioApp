            ...
            <div class="content">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">Nama Pasien</h3>
                                                <div class="staff-id">No. Registrasi : DR-0001</div>
                                                <div class="staff-id">Alamat : Jl. Luar Biasa no. 99</div>
                                                <div class="staff-id">No. Telepon/HP : 081234567890</div>
                                            </div>
                                        </div> -->
                                        <div class="col-md-7">
                ...
                <div class="profile-tabs">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item"><a class="nav-link active" href="#about-cont" data-toggle="tab">Rekam Medis</a></li>
                        <li class="nav-item"><a class="nav-link" href="#bottom-tab2" data-toggle="tab">Rekam Kasir</a></li>
                    </ul>
